...
// Returns board indices that are adjacent to the blank tile
const getAdj = (b) => {
...
// Pixel position for a board index (used with CSS transform: translate)
const tilePos = (i) => ({
  x: GAP + (i % N) * (TILE + GAP),
